...
<head>
    ...
    <title>Cadastrar Funcionario - WaitCenter</title>
...
<body class="skin-blue fixed-layout">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Cadastrar funcionario</h4>
                    </div>
    ...
    <script src="../assets/node_modules/wizard/jquery.steps.js"></script>
